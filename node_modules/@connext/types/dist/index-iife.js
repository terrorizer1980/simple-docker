...
this.window.types = (function (exports, utils, ethers, providers, constants, EventEmitter) {
  'use strict';
  ...
  const CONVENTION_FOR_ETH_ASSET_ID = constants.AddressZero;
...
}({}, utils, ethers, providers, constants, EventEmitter));
