...
export declare type MultiAssetMultiPartyCoinTransferInterpreterParamsJson = Omit<MultiAssetMultiPartyCoinTransferInterpreterParams, "limit"> & {
    limit: BigNumberJson[];
};
...
export declare type SingleAssetTwoPartyCoinTransferInterpreterParamsJson = Omit<SingleAssetTwoPartyCoinTransferInterpreterParams, "limit"> & {
    limit: BigNumberJson;
};
...
export declare type TwoPartyFixedOutcomeInterpreterParamsJson = Omit<TwoPartyFixedOutcomeInterpreterParams, "amount"> & {
