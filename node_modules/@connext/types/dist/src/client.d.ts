...
export interface IConnextClient {
    ...
    on<T extends EventName>(event: T, callback: (payload: EventPayload[T]) => void | Promise<void>, filter?: (payload: EventPayload[T]) => boolean): void;
    once<T extends EventName>(event: T, callback: (payload: EventPayload[T]) => void | Promise<void>, filter?: (payload: EventPayload[T]) => boolean): void;
    ...
    checkDepositRights(params: PublicParams.CheckDepositRights): Promise<PublicResults.CheckDepositRights>;
    conditionalTransfer(params: PublicParams.ConditionalTransfer): Promise<PublicResults.ConditionalTransfer>;
    deposit(params: PublicParams.Deposit): Promise<PublicResults.Deposit>;
    requestDepositRights(params: PublicParams.RequestDepositRights): Promise<MethodResults.RequestDepositRights>;
    rescindDepositRights(params: PublicParams.RescindDepositRights): Promise<PublicResults.RescindDepositRights>;
    ...
    getAppInstance(appIdentityHash: Bytes32): Promise<MethodResults.GetAppInstanceDetails | undefined>;
    getProposedAppInstances(multisigAddress?: Address): Promise<MethodResults.GetProposedAppInstances | undefined>;
    getProposedAppInstance(appIdentityHash: Bytes32): Promise<MethodResults.GetProposedAppInstance | undefined>;
