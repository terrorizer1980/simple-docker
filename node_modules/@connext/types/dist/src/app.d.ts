import { ABIEncoding, Address, AssetId, DecString, HexString, PublicIdentifier, SolidityValueType } from "./basic";
import { MultiAssetMultiPartyCoinTransferInterpreterParams, MultiAssetMultiPartyCoinTransferInterpreterParamsJson, OutcomeType, SingleAssetTwoPartyCoinTransferInterpreterParams, SingleAssetTwoPartyCoinTransferInterpreterParamsJson, TwoPartyFixedOutcomeInterpreterParams, TwoPartyFixedOutcomeInterpreterParamsJson } from "./contracts";
export declare type AppInterface = {
    addr: Address;
