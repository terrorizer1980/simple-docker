...
const artifacts = {};
const buildDir = process.env.CONTRACT_ARTIFACTS_DIR || "../build/"
for (const contract of coreContracts) {
    artifacts[contract] = require(`${buildDir}/${contract}.json`);
}
...
const addressBookPath = process.env.ADDRESS_BOOK_PATH || ".";
const addressBook = JSON.parse(fs.readFileSync(`${addressBookPath}/address-book.json`, "utf8") || "{}");
